...
function () {
  ...
  function Enum() {
    ...
    this.pushCase = function (id, val) {
      if (_typeof(val) !== _this[CONFIG].type && typeof val !== 'undefined') throw new Error("Raw value must conform to the specified type.\nRaw value: ".concat(typeof rawValue === "undefined" ? "undefined" : _typeof(rawValue), ", Expected: ").concat(_this[CONFIG].type));

      _this.ids.push(id);

      var newCase = {
        id: id,
        rawValue: _this.typeResolve(id, val, _this[CONFIG].type)
      };
      _this[id] = newCase;
